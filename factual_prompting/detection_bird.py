...
parser.add_argument("--result_dir", "-o", type=str, default='/projects/ml4science/project_LMM/factual_prompting/bird_detection', help="path to output")
