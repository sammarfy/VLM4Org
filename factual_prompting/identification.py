...
if args.dataset == 'fish-10k':
    ...
    args.result_dir = root_dir+'VLM4Bio/fact_prompt_results/fish-10k'
    ...
    args.result_dir = root_dir+'VLM4Bio/fact_prompt_results/bird'
