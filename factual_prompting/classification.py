...
if args.dataset == 'fish-10k':
    ...
    args.result_dir = '/projects/ml4science/VLM4Bio/fact_prompt_results/fish-10k'
    
    images_list_path = '/projects/ml4science/VLM4Bio/datasets/Fish/metadata/imagelist_10k.txt'
    image_dir = '/projects/ml4science/VLM4Bio/datasets/Fish/images'
    img_metadata_path = '/projects/ml4science/VLM4Bio/datasets/Fish/metadata/metadata_10k.csv'
    organism = 'fish'

elif args.dataset == 'fish-500':

    args.result_dir = '/projects/ml4science/VLM4Bio/fact_prompt_results/fish-500'
    
    images_list_path = '/projects/ml4science/VLM4Bio/datasets/Fish/metadata/imagelist_500.txt'
    image_dir = '/projects/ml4science/VLM4Bio/datasets/Fish/images'
    img_metadata_path = '/projects/ml4science/VLM4Bio/datasets/Fish/metadata/metadata_500.csv'
    organism = 'fish'

elif args.dataset == 'bird':

    args.result_dir = '/projects/ml4science/VLM4Bio/fact_prompt_results/bird'
    
    images_list_path = '/projects/ml4science/VLM4Bio/datasets/Bird/metadata/bird_imagelist_10k.txt'
    ...
    args.result_dir = '/projects/ml4science/VLM4Bio/fact_prompt_results/butterfly'
    
    images_list_path = '/projects/ml4science/VLM4Bio/datasets/Butterfly/metadata/imagelist.txt'
    image_dir = '/projects/ml4science/VLM4Bio/datasets/Butterfly/images'
    img_metadata_path = '/projects/ml4science/VLM4Bio/datasets/Butterfly/metadata/metadata.csv'
    organism = 'butterfly'
